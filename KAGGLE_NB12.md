...
NB12 is the final foreign-country model-selection run before India is opened.
...
Use the notebook at `deliverables/SIH_NB12_CV_Tabular.ipynb`.
...
of the predictive feature matrix and India must remain sealed until the foreign
design is frozen.
